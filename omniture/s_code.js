...
/********ALL COMMENTED OUT VARIABLES SHIFTED TO BRAND SPECIFIC JS FILES*********/
//var s_account="hitdev"
...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls,flv"
//s.linkInternalFilters="javascript:,hitentertainment.com"
...
function s_doPlugins(s) {
	...
	s.prop11=s.getTimeParting('h','-5','2007'); // Set hour 
	...
	if(s.prop14&&!s.eVar17) s.eVar17=s.prop14;
	if(s.prop15&&!s.eVar18) s.eVar18=s.prop15;
	if(s.prop16&&!s.eVar19) s.eVar19=s.prop16;
	if(s.prop17&&!s.eVar20) s.eVar20=s.prop17;
}
...
//s.trackingServer="metrics.hitentertainment.com"
s.trackingServerSecure="smetrics.hitentertainment.com"
s.dc=112
